'use client'
 {/* FilterQuestions comp is the comp which holds specefic questions to train the bot to ask them to the client */} 
    ...
    <Card className="w-full grid grid-cols-1 lg:grid-cols-2">
      <CardContent className="p-6 border-r-[1px]">
        ...
        >
          ...
          {/* the answer of the question will be generated with AI. basically, we don't need the answer div we just made it for the sake of the UI aesthetic */}
          <div className="flex flex-col gap-3">
            <Section
