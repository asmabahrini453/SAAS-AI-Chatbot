...
const CodeSnippet = ({ id }: Props) => {
  ...
  //JavaScript code for embedding a chatbot iframe on a website. 
  let snippet = `
    ...
    window.addEventListener("message", (e) => {
        ...
        `
 //the snippet sends the id back to the iframe, allowing the chatbot to load content specific to that user with that specefic domain.
    return (
