...
import { CustomerTable } from '@/app/(dashboard)/email-marketing/customer-table'
import Modal from '../modal'
import { EditEmail } from '@/app/(dashboard)/email-marketing/edit-email'
  ...
  return (
    <div className="w-full flex-1 h-0 grid grid-cols-1 lg:grid-cols-2 gap-10">
      ...
      <div>
        ...
        <div className="flex flex-col items-end mt-5 gap-3 mr-5">
          {campaign &&
            campaign.map((camp, i) => (
              <Card
                key={camp.id}
