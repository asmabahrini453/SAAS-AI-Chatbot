...
//forwardREf: to get access to everything we passed in the props
  ...
  (
    ...
    return (
      <div className="h-[670px] w-[450px] flex flex-col bg-white rounded-xl mr-[80px] border-[1px] overflow-hidden">
        ...
        >
            {/* //this is where we toggle from featured questions to help questions */}
        ...
        <div className="flex justify-center ">
          <p className="text-gray-400 text-xs">Powered By DevPRO Solutions</p>
        </div>
      </div>
    )
  }
